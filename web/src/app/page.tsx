					...
					<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
						...
						<div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto justify-between sm:justify-end flex-wrap">
							...
							<div className="flex items-center gap-1 sm:gap-2">
								...
								<Link
									href="/rss"
									className="p-2 bg-white/80 backdrop-blur-sm text-orange-500 rounded-lg hover:bg-white hover:shadow-md transition-all duration-200 border border-gray-200"
									title="Feed Reader"
								>
									<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
