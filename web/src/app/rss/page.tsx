...
export default function RSSPage() {
		...
		return (
			<div className="min-h-screen flex items-center justify-center app-bg-gradient">
				<div className="flex flex-col items-center gap-4">
					...
					<p className="text-orange-600 dark:text-orange-400 font-medium">Loading RSS Feeds...</p>
				</div>
			</div>
		);
	}
	...
	if (error && feeds.length === 0) {
		return (
			<div className="min-h-screen flex items-center justify-center app-bg-gradient">
				<div className="text-center bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm p-8 rounded-2xl shadow-lg">
	...
	return (
		<div className="min-h-screen flex flex-col app-bg-gradient">
			...
			{/* Header */}
			<header className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm shadow-sm z-10 sticky top-0 border-b border-gray-100 dark:border-slate-700">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
					<div className="flex items-center gap-4">
						<Link href="/" className="flex items-center gap-2 px-3 py-2 bg-white/80 dark:bg-slate-700/80 text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white font-medium rounded-xl hover:shadow-md transition-all border border-gray-200 dark:border-slate-600">
							<svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
								<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
							</svg>
