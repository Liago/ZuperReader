...
struct Typography {
    ...
    enum FontFamily: String, CaseIterable, Codable {
        ...
        var font: Font {
            ...
            case .roboto: return .custom("Roboto", size: 16)
            case .lato: return .custom("Lato", size: 16)
            case .openSans: return .custom("OpenSans", size: 16)
            case .ubuntu: return .custom("Ubuntu", size: 16)
            }
        }
        ...
        func font(size: CGFloat) -> Font {
            ...
            case .lato: return .custom("Lato", size: size)
            case .openSans: return .custom("OpenSans", size: size)
